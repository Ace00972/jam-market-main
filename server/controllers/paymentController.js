...
const initiateWiPay = async (req, res) => {
  try {
    ...
    // Build WiPay form URL
    const wipayUrl = 'https://sandbox.wipayfinancial.com/v1/gateway';
...
module.exports = { initiateWiPay, initiatePayPal, paymentCallback, simulatePayment };